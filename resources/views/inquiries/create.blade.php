    ...
    <div class="flex flex-col justify-center items-center py-8 px-6 mx-auto">
        <div class="bg-white p-6 shadow-md md:rounded-lg border border-gray-100 justify-center items-center w-full rounded-lg lg:flex md:mt-0 lg:max-w-screen-lg xl:p-0">
            <div class="p-6 w-full sm:p-8 lg:p-10">
                ...
                <h1 class="text-center text-3xl mb-5">Ask a Question</h1>
                <form method="POST" action="{{ route('inquiries.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="question" name="question" rows="3" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-purple-500 focus:border-purple-500" placeholder="Write your question here...">{{ old('question') }}</textarea>
                        @error('question')
