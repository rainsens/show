                ...
                <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
                    <div class="flex items-center justify-between mb-4">
                        <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white">
                            Links for Project: <span class="text-purple-700">{{ $project->title }}</span>
                        </h5>
                        <a href="{{ route('projects.links.create', $project) }}" type="button" class="px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-purple-700 rounded-lg hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="flex-1 min-w-0 ms-4">
                                            <p class="text-sm font-medium text-gray-900 truncate dark:text-white">
                                                <a href="{{ $link->link }}" target="_blank" class="hover:text-purple-700">
                                                    {{ $link->title }}
                                                </a>
                                            </p>
                                        </div>
                                        <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                            <a href="{{ route('links.edit', $link) }}" type="button" class="inline-flex items-center text-purple-700 hover:text-white border border-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-xs px-3 py-2 text-center">
                                            ...
                                            <x-delete :action="route('links.destroy', $link)" />
