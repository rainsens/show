                ...
                <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
                    <div class="flex items-center justify-between mb-4">
                        <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white">
                            Images for Project: <span class="text-purple-700">{{ $project->title }}</span>
                        </h5>
                        <a href="{{ route('projects.images.create', $project) }}" type="button" class="px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-purple-700 rounded-lg hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300">
                                ...
                                <li class="py-3 sm:py-4">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0">
                                            <img class="w-20 rounded-lg" src="{{ Str::startsWith($image->image, 'http') ? $image->image : asset($image->image) }}" alt="">
                                        </div>
                                        ...
                                        <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                            <a href="{{ route('images.edit', $image) }}" type="button" class="inline-flex items-center text-purple-700 hover:text-white border border-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-xs px-3 py-2 text-center">
                                            ...
                                            <x-delete :action="route('images.destroy', $image)" />
